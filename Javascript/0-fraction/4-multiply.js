...
// La MULTIPLICACIÓN(corregido) de la fracción 2/3 y la fracción 3/4 es la fracción 6/12
...
console.writeln(
  `La multiplicación de la fracción ${num1}/${den1} y la fracción ${num2}/${den2} es la fracción ${
    num1 * num2
  }/${den1 * den2}`
);
